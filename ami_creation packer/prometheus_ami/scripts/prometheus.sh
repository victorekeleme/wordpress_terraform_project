...
cat /home/ubuntu/prometheus.yml | sudo tee /etc/prometheus/prometheus.yml
cat /home/ubuntu/prometheus.rules.yml | sudo tee /etc/prometheus/prometheus.rules.yml
cat /home/ubuntu/prometheus.service | sudo tee /etc/systemd/system/prometheus.service
